...
# Update the connection parameters based on your phpMyAdmin and MySQL setup
connection_config = {
    'host': 'localhost',  # Your MySQL server (phpMyAdmin manages this server)
...
def insert_order_tracking(order_id, status):
    ...
    insert_query = "INSERT INTO ordertracking (order_id, status) VALUES (%s, %s)"
